...
export default function AccountPage() {
  ...
  const { user, loading: authLoading, isAuthenticated, hasActiveSubscription } = useAuth();
              ...
              <div className="space-y-4">
                ...
                {user?.subscriptionExpiresAt && (
                  <div>
                    ...
                    <p className="text-foreground">{formatDate(user.subscriptionExpiresAt)}</p>
                  </div>
                )}
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            Abonamentul va ramane activ pana la {formatDate(user?.subscriptionExpiresAt)},
